...
Búsqueda: primero en `data/raw/`, después en la raíz del proyecto. Si hay varios
matches (ej. el cliente dejó el de abril y el de junio), toma el más reciente
por mtime y avisa por consola.
"""
...
def explain_missing(lf: LodgeFiles) -> str:
    ...
    return (
        ...
        f"Copialos a la raíz del proyecto o a data/raw/."
    )
