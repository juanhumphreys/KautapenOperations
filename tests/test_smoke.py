...
FILES = discover_delta(ROOT)
assert FILES.control_xlsx is not None, "falta el Excel de control de Delta en data/raw/"
assert FILES.budget_xlsx is not None, "falta el Excel de budget de Delta en data/raw/"
DELTA = FILES.control_xlsx
BUDGET = FILES.budget_xlsx
